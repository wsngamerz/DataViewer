...
// MockFacebookUseCase_GetChatSummary_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetChatSummary'
type MockFacebookUseCase_GetChatSummary_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - id string
func (_e *MockFacebookUseCase_Expecter) GetChatSummary(ctx interface{}, id interface{}) *MockFacebookUseCase_GetChatSummary_Call {
	return &MockFacebookUseCase_GetChatSummary_Call{Call: _e.mock.On("GetChatSummary", ctx, id)}
}

func (_c *MockFacebookUseCase_GetChatSummary_Call) Run(run func(ctx context.Context, id string)) *MockFacebookUseCase_GetChatSummary_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockFacebookUseCase_GetChatSummary_Call) Return(chatSummaryDTO dtos.ChatSummaryDTO, err error) *MockFacebookUseCase_GetChatSummary_Call {
	_c.Call.Return(chatSummaryDTO, err)
	return _c
}

func (_c *MockFacebookUseCase_GetChatSummary_Call) RunAndReturn(run func(ctx context.Context, id string) (dtos.ChatSummaryDTO, error)) *MockFacebookUseCase_GetChatSummary_Call {
	_c.Call.Return(run)
	return _c
}
